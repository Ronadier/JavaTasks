...
public class Task6 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    printHelper(usersIndicatedAges(humans, inputAge));
    System.out.println();
    System.out.println("Люди старше " + inputAge + " лет");
    printHelper(usersOlderIndicatedAge(humans, inputAge));
    System.out.println();
    System.out.println("Люди младше или в возрасте " + inputAge + " лет");
    printHelper(usersYoungeraAndIndicatedAge(humans, inputAge));
    System.out.println();
    System.out.println("Совершеннолетние");
    printHelper(adults(humans, agesConfig));
    System.out.println();
    System.out.println("Тины");
    printHelper(teens(humans, agesConfig));
    System.out.println();
    System.out.println("Битые записи");
    printHelper(brokens(humans, agesConfig));
    System.out.println();
